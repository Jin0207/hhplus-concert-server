...
public class PaymentController {
    ...
    @Operation(summary = "결제 처리", description = "예약 건을 결제하고 결제 내역을 생성합니다. 결제 금액은 좌석 가격 기준으로 서버에서 계산됩니다.")
    @ApiResponses({
    ...
    public ResponseEntity<PaymentResponse> createPayment(
        ...
        return ResponseEntity.ok(new PaymentResponse(null, request.reservationId(), null, 0L, null, null));
    }
}
